...
-- Signed G2 product manifest: sha256 1f6e31422461173cd4b4671417809f8b819bad493efec2fb0a5cdd2783d37a63, 284064 bytes.
...
BEGIN;
DO $$ BEGIN ASSERT current_database() = 'clarityit', 'G3 baseline requires POSTGRES_DB=clarityit'; END $$;
...
-- The signed inventory identifies exactly ten application functions.
...
-- Foreign keys are deferred until every referenced table exists.
